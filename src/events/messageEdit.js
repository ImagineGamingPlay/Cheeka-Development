//This is the part that allows bot to run on edited messages.
//messageUpdate.js already exists and is bulky so i didnt want to make it huge.
...
module.exports = {
	...
	async execute(oldMessage, message, client) {
		...
		if (config.emojiReactionChannels.includes(message.channel.id)) {
			const EMOJIREGEX =
